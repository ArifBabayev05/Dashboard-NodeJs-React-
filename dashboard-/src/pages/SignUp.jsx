            ...
            <div class="w-full bg-white rounded shadow-lg p-8 m-4 md:max-w-sm md:mx-auto">
                ...
                <form onSubmit={(e) => {
                    ...
                    {disabled ?
                        ...
                        <div>
                            {/* <p data-popover-target="popover-description" data-popover-displacement="bottom-end">Test</p> */}
                            <i class="fa-solid text-center text-red-500 w-100 fa-circle-info float-center justify-center text-3xl" data-popover-target="popover-description" data-popover-displacement="bottom-end"></i>
                            <div data-popover="" id="popover-description" role='tooltip' className='inline-block absolute invisible z-10 w-72 text-sm font-light bg-white rounded-lg border border-gray-200'
                                style={{ 'position': 'absolute', 'inset': '0px auto auto 0px', 'margin': '0px', 'transform': 'translate(0px,559px)' }}
                            >
                                <div className='p-3 space-y-2'>
                                    <svg aria-hidden="true" class="mx-auto mb-4 w-14 h-14 text-red-500 dark:text-gray-200" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                    <div>
                                        <h3 class="mb-5 text-normal font-normal text-gray-500 dark:text-gray-400"><span className='text-purple-700 font-bolder'>Full Name</span> length must be higher than 3</h3>
                                        <h3 class="mb-5 text-normal font-normal text-gray-500 dark:text-gray-400"><span className='text-purple-700 font-bolder'>Phone Number</span>  length must be higher than 7</h3>
                                        <h3 class="mb-5 text-normal font-normal text-gray-500 dark:text-gray-400"><span className='text-purple-700 font-bolder'>Email</span>  length must be higher than 5</h3>
                                        <h3 class="mb-5 text-normal font-normal text-gray-500 dark:text-gray-400"><span className='text-purple-700 font-bolder'>Password</span>  Length must be higher than 8</h3>
                                        <h3 class="mb-5 text-normal font-normal text-gray-500 dark:text-gray-400"><span className='text-purple-700 font-bolder'>Password</span>  must include at least one Uppercase,lowercase,number and special characters</h3>
                                    </div>
                                </div>
