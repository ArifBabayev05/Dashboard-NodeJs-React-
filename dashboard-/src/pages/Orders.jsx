          ...
          <div className='flex'>
            <div className='p-2 w-100 bg-white justify-between rounded-3xl dark:bg-secondary-dark-bg' style={{ 'display': 'content', 'width': '100%' }}>
              ...
              <div class="inline-flex rounded-md shadow-sm" role="group">
                ...
                <a href='/orderr' type="button" class="inline-flex items-center py-2 px-4 text-sm font-medium text-gray-900 bg-white rounded-r-lg border border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white">
          ...
          <div className="container">
            <table>
              <tr>
                ...
                <th className='text-danger'><i className='fa-solid fa-trash text-red-500'></i></th>
              </tr>
              {array}
            </table>
          </div>
